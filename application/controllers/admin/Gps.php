 ...
 */
    ...
    public function index() {
        ...
        $this->load->view('admin/vwGps', $data);
    }  
    
    public function get_users_gps() {
        $data['mensaje']='Aun no se ha registrado usuarios de solo GPS';
        $data['datos'] = $this->Gps_model->get_users_gps();
        $this->load->view('admin/vwGpsUsers', $data);
    }
    ...
    public function get_user_gps_xid($id) {
        ...
        $data['conxid']=  $this->Gps_model->get_user_gps_xid($id);
        $this->load->view('admin/vwFormUserGps', $data);
    }
