...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'index.php/veterinario/Perfil/get_empresa' ?>"><i class="icon-dashboard"></i> Volver Atras</a></li>
    ...
    <form method="post" action="<?php echo base_url() . 'index.php/veterinario/Perfil/update_empresa' ?>" id="basicBootstrapForm" class="form-horizontal">
