...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">                     
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'index.php/conductor/Correo' ?>"><button type="button" class="btn btn-warning">Enviar correo para solicitar cambio de documentos y/o datos bloqueados</button></a></li>
                <!--<li class="active"><i class="icon-file-alt"></i> <select id="combito">
                        <option>Seleccione tipo de archivos</option>
                        <option value="1">Foto x Foto</option>
                        <option value="2">zip - rar - pdf - docx - txt</option>                   
    ...
    <div>
        ...
        <form action="<?php echo base_url() . 'index.php/conductor/Perfil/edit_foto_doc' ?>" enctype="multipart/form-data" method="post">
            <div align="center"><img id="foto_doc" src="<?php echo base_url() ?>uploads/<?php
                foreach ($doc as $row) {
        ...
        <form action="<?php echo base_url() . 'index.php/conductor/Perfil/edit_foto_lic' ?>" enctype="multipart/form-data" method="post">
            <div align="center"><img id="foto_lic" src="<?php echo base_url() ?>uploads/<?php
                foreach ($lic as $row) {
    ...
    <div>
        ...
        ?>"/>
        <form action="<?php echo base_url() . 'index.php/conductor/Perfil/edit_user_pdf' ?>" enctype="multipart/form-data" method="post">
            <div align="center"><h4>Documento Actual:<a href="<?php echo base_url() . 'uploads/' . $row->pdf ?>" target="parent"> <?php echo $row->pdf?></a></h4></div>
            <!--<div align="center">                
