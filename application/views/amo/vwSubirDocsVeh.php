...
<div id="page-wrapper">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_soat' ?>" enctype="multipart/form-data" method="post">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_rtecno' ?>" enctype="multipart/form-data" method="post">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_lict' ?>" enctype="multipart/form-data" method="post">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_cedp' ?>" enctype="multipart/form-data" method="post">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_rutp' ?>" enctype="multipart/form-data" method="post">
    ...
    <form action="<?= base_url() . 'index.php/conductor/Perfil/edit_foto_carnet' ?>" enctype="multipart/form-data" method="post">
