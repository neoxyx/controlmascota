...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li><a href="<?=base_url().'index.php/conductor/Dashboard'?>"><i class="icon-dashboard"></i> Volver Atras</a></li>
    ...
    <form method="post" action="<?= base_url() . 'index.php/conductor/Correo/send_mail' ?>" id="basicBootstrapForm" class="form-horizontal">
