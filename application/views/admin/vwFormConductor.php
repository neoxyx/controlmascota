...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'index.php/admin/Conductores' ?>"><i class="fa fa-level-up"></i></a></li>
    ...
    <form method="post" action="<?php echo base_url() . 'index.php/admin/Conductores/edit_conductor' ?>" id="basicBootstrapForm" class="form-horizontal">
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <select class="form-control" name="tipo_vivienda">
                    <option value="<?php
                    echo $row->tipo_vivienda;
                    ?>">Actual: <?php
                                echo $row->tipo_vivienda;
                                ?></option>
                    <option value="">Seleccione si desea cambiar</option>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "licencia" value="<?php
        ...
        <div class = "form-group">
            ...
            <div class="col-xs-2">
                <input type="text" class="form-control" readonly name="theDatev" value="<?php
        ...
        <div class = "form-group">
            <div class = "col-xs-9 col-xs-offset-3">
                <button type = "submit" class = "btn btn-primary" name = "update_conductor" value = "Sign up">Actualizar</button>
            </div>
        </div>
    </form>
</div><!--/#page-wrapper -->
