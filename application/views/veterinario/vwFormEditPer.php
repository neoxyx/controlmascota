...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1>Cliica <small>Editar Personal</small></h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'index.php/veterinario/Perfil/get_personal' ?>"><i class="icon-dashboard"></i> Volver Atras</a></li>
    ...
    <form method="post" action="<?php echo base_url() . 'index.php/veterinario/Perfil/update_personal' ?>" id="basicBootstrapForm" class="form-horizontal">
