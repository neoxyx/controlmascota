...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url() . 'index.php/admin/Perfil/get_perfil' ?>"><i class="fa fa-level-up"></i></a></li>
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'index.php/admin/Perfil/edit_user' ?>" id="basicBootstrapForm" class="form-horizontal">
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <select name="vivienda" class="form-control"> 
                    ...
                    ?>">Actual: <?php echo $row->tipo_vivienda?></option>                    
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <select name="categoria_lic"  class="form-control"> 
                    ...
                    ?>">Actual: <?php echo $row->categoria_lic?></option>                    
