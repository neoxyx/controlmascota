...
<div id="page-wrapper">
    ...
    <form method="post" action="<?= base_url() . 'index.php/veterinario/Mascotas/guardar_mascota' ?>" id="basicBootstrapForm" class="form-horizontal">
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                ...
                <h5><a href="<?= base_url() . 'index.php/veterinario/Amo/add_amo' ?>">Si el propietario no esta en la lista, registrelo aqui por favor.</a></h5>
            </div>
        </div>
