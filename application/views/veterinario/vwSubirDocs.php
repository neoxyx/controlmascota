...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">                     
            <ol class="breadcrumb">
                <li><a href="<?= base_url() . 'index.php/empresa/Dashboard/send_mail' ?>"><button type="button" class="btn btn-warning">Enviar correo para solicitar cambio de documentos y/o datos</button></a></li>
                <!--<li class="active"><i class="icon-file-alt"></i> <select id="combito">
                        <option>Seleccione tipo de archivos</option>
                        <option value="1">Foto x Foto</option>
                        <option value="2">zip - rar - pdf - docx - txt</option>                   
    ...
    <div>
        ...
        <form action="<?= base_url() . 'index.php/empresa/Perfil/edit_foto_doc' ?>" enctype="multipart/form-data" method="post">
        ...
        <form action="<?= base_url() . 'index.php/empresa/Perfil/edit_foto_lic' ?>" enctype="multipart/form-data" method="post">
    ...
    <div>
        ...
        ?>"/>
        <form action="<?= base_url() . 'index.php/empresa/Perfil/edit_user_pdf' ?>" enctype="multipart/form-data" method="post">
