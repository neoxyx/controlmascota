...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li><a href="<?= base_url() . 'index.php/admin/Perfil/get_perfil' ?>"><i class="fa fa-level-up"></i></a></li>
    ...
    <form method="post" enctype="multipart/form-data" action="<?= base_url() . 'index.php/admin/Perfil/edit_user' ?>" id="basicBootstrapForm" class="form-horizontal">
