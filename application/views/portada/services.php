		...
		<div class="banner-navigation">
				<div class="banner-nav">
						<ul class="resp-menu orange nav1">
							<li class="cap"><a href="<?php echo base_url().'index.php/Portal'?>">Home</a></li>
							<li><a href="<?php echo base_url().'index.php/Portal/nosotros'?>">Acerca de nosotros</a></li>
							<li class="active"><a href="JavaScript:void(0)">Services</a>
								<ul>
									<li><a href="<?php echo base_url().'index.php/Portal/services'?>">Service1</a></li>
									<li><a href="<?php echo base_url().'index.php/Portal/services'?>">Service2</a></li>
								</ul>
							</li>
							<li><a href="<?php echo base_url().'index.php/Portal/contact'?>">Contactenos</a></li>
						</ul>
					<div class="clear"> </div>
				</div>
		</div>                                                                                      
