    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <a href="<?= base_url() . 'index.php/empresa/Ofertas' ?>"><button class="btn btn-info" type="button" style="float:right;" id="add_pais">Volver a ofertas</button></a>
        ...
        <table class="table table-hover tablesorter">
            ...
            <tbody>
                ...
                foreach ($oferta as $row) {
                    ?>
                <form  action="<?= base_url() . 'index.php/empresa/Ofertas/update_oferta/' . $row->id ?>"  method="post" >
                    <tr>
