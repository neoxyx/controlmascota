...
class Googlemaps {
	...
	var $center						= "4.5980556, -74.0758333";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
