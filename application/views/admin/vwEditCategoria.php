...
<div id="page-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'index.php/admin/Categorias/edit_categoria' ?>" id="basicBootstrapForm" class="form-horizontal">
