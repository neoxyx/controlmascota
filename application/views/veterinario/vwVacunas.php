    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <a href="<?= base_url() . 'index.php/veterinario/Pacientes/add_vacuna/'.$id_masc ?>"><button class="btn btn-info" type="button" style="float:right;" id="add_pais">Añadir Vacuna</button></a>
