		...
		<div class="banner-navigation">
				<div class="banner-nav">
						<ul class="resp-menu orange nav1">
							<li class="cap active"><a href="<?php echo base_url().'index.php/Portal'?>">Inicio</a></li>
                                                        <li class=""><a href="<?php echo base_url().'index.php/Portal/nosotros'?>">Sobre Nosotros</a></li>
		 ...
		 <div class="slider">
	      	<div class="slider-wrapper theme-default">
	            <div id="slider" class="nivoSlider">
	                <img src="<?php echo base_url().'assets/images_portada/banner4.jpg'?>" alt="" />
	                <img src="<?php echo base_url().'assets/images_portada/banner3.jpg'?>" alt="" />
	                <img src="<?php echo base_url().'assets/images_portada/banner2.jpg'?>" alt="" />
	                <img src="<?php echo base_url().'assets/images_portada/banner1.jpg'?>" alt="" />
	                <img src="<?php echo base_url().'assets/images_portada/banner5.jpg'?>" alt="" />
	            </div>
	       </div>
         </div>
  <!------End Slider ------------>
		 ...
		 <div class="content-top">
			<div class="section group">
				<div class="col_1_of_3 span_1_of_3">
					<div class="grid_4">
	                    <div class="box-1">
	                        <img src="<?php echo base_url().'assets/images_portada/pic3.jpg'?>" alt="" class="wrapper">
	                        <div class="inside">
				...
				<div class="col_1_of_3 span_1_of_3">
					<div class="grid_4">
	                    <div class="box-1">
	                        <img src="<?php echo base_url().'assets/images_portada/pic4.jpg'?>" alt="" class="wrapper">
	                        <div class="inside">
				...
				<div class="col_1_of_3 span_1_of_3">
					<div class="grid_4">
	                    <div class="box-1">
	                        <img src="<?php echo base_url().'assets/images_portada/pic5.jpg'?>" alt="" class="wrapper">
	                        <div class="inside">
