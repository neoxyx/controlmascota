    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <button class="btn btn-primary" type="button" style="float:right;" id="add_pais">Añadir Usuario GPS</button>
            ...
            <tbody>
                ...
                if (!$datos) {
                    ...
                    foreach ($datos as $row) {
                        ...
                        echo"<td>" . anchor(base_url() . 'index.php/admin/Gps/get_user_gps_xid/' . $row->id, '<button type="button" class="btn btn-warning">VER - EDITAR</button>') . "</td>";
                        echo "</tr>";
                    }
                }
                ?>   
