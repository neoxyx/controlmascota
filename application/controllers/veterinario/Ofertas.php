...
class Ofertas extends CI_Controller {
    ...
    public function index() {
        $data['mensaje'] = 'No has realizado ofertas';
        $data['ofertas'] = $this->Ofertas_model->get_ofertas_emp();
        $this->load->view('empresa/vwOfertas', $data);
    }
...
//en data['map'] tenemos ya creado nuestro mapa para llamarlo en la vista
        ...
        $this->load->view('empresa/vwVerOferta', $data);
    }

    public function delete_oferta($id) {
        $this->Ofertas_model->delete_oferta($id);
        redirect(base_url() . 'index.php/empresa/Ofertas');
    }
