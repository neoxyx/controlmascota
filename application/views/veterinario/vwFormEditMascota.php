...
<div id="page-wrapper">
    ...
    <form method="post" action="<?php echo base_url() . 'index.php/veterinario/Pacientes/edit_paciente' ?>" id="basicBootstrapForm" class="form-horizontal" enctype="multipart/form-data">
